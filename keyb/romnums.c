...
void merge_functions() {                     /* This goes through and modifies the chord info. If a chord has the same root as
...
void display_running() {                  /* generates preferred analysis at each segment */
